...
class GestionSucursales extends Component
{
    ...
    {
        $sucursales = Sucursal::where('nombre', 'like', '%' . $this->searchTerm . '%')
            ->orWhere('direccion', 'like', '%' . $this->searchTerm . '%')
            ->paginate(10);
    ...
    public function store()
    {
        ...
        session()->flash('message',
            $this->sucursal_id ? 'Sucursal actualizada correctamente.' : 'Sucursal creada correctamente.');
